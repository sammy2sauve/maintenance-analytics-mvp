...
import {
  FileText, Bell, Clock, BookOpen,
  ChevronRight, Plus, Trash2, ToggleLeft, ToggleRight,
  Download, Mail, Calendar, AlertTriangle, CheckCircle, Info
} from 'lucide-react';
...
const REPORT_SECTIONS = [
  ...
  { id: 'cost_savings', label: 'Cost Savings Analysis', checked: false },
    ...
    <div className="bg-slate-800/60 border border-slate-700/50 rounded-xl p-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-3">Deliver to</p>
            <input
              type="email"
          ...
          <div className="flex gap-2 pt-2">
            <button className="flex-1 flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium py-2.5 rounded-lg transition-colors">
              <Download className="w-4 h-4" />
              Download
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-slate-200 text-sm font-medium py-2.5 rounded-lg transition-colors">
          ...
          <p className="text-[11px] text-slate-500 text-center">
            Report generation coming soon — backend integration in progress
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="px-2.5 py-1 text-xs font-medium bg-amber-500/10 text-amber-400 border border-amber-500/20 rounded-full">
          Preview — backend integration coming soon
        </span>
      </div>
